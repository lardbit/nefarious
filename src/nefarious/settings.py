...
# log to shared /nefarious-db path when using default container configuration, otherwise fallback to /tmp
log_path = '/nefarious-db' if os.path.exists('/nefarious-db') else '/tmp'
